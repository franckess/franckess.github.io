---
title: "Uploading files to Azure Blob using Flask"
author: "Rene Essomba"
date: '2020-09-20'
...
All you have to do is to run your newly created Flask App locally

```
$ export FLASK_APP=flask_app.py
$ flask run
```
2. Run and test your running Docker container:
```
