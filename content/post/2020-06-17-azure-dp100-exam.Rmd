...
The DP-100 Exam is designed to evaluate to perform the following tasks:
...
* Supervised Learning
  ...
  2. Classification: Logistic Regression, Linear Discriminant Analysis, Support Vector Machine, Multi-classification, etc.
...
* [https://github.com/MicrosoftLearning/DP100](https://github.com/MicrosoftLearning/DP100) This repo contains a series of labs and Jupyter notebooks for DP-100 by [Microsoft Learning](https://github.com/MicrosoftLearning) GitHib account. **Highly Recommende**.
...
* [UMass Amherst Student Samples](https://github.com/katiehouse3/microsoft-azure-ml-notebooks) - A number of end-to-end 

machine learning notebooks, including machine translation, image classification, and customer churn, created by students in the 696DS course at UMass Amherst.

_I hope you found this blogpost valuable. Please drop a comment below for feedback :-)_
